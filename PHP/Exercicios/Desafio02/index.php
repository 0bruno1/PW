    ...
    <div class="container">
        <?php
                ...
                if($imc < 18.5){
                    ...
                    echo "<img src='images/normal.jpg' class ='magreza' 100px 300px> ";
                }
                else if($imc < 29.9 ){
                    echo "<p>" . "você tem $altura m de altura" . "</p>";
                    echo "<p>" ."Voce possui $peso Kg". "</p>";
                    echo "<p> Seu IMC é de: $imc " . " O que significa que está em excesso de peso.";
                    echo "<img src='images/sobrepeso.jpg' class ='magreza' 100px 300px> ";
                }
                else if($imc <= 34.9 ){
                    echo "<p>" . "você tem $altura m de altura" . "</p>";
                    echo "<p>" ."Voce possui $peso Kg". "</p>";
                    echo "<p> Seu IMC é de: $imc " . " O que significa que está em Obesidade I.";
                    echo "<img src='images/obesidade1.jpg' class ='magreza' 100px 300px> ";
                }
                else if($imc < 39.9 ){
                    echo "<p>" . "você tem $altura m de altura" . "</p>";
                    echo "<p>" ."Voce possui $peso Kg". "</p>";
                    echo "<p> Seu IMC é de: $imc " . " O que significa que está em Obesidade II.";
                    echo "<img src='images/obesidade2.png' class ='magreza' 100px 300px> ";
                }
                else{
                    echo "<p>" . "você tem $altura m de altura" . "</p>";
                    echo "<p>" ."Voce possui $peso Kg". "</p>";
